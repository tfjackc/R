...
```
**Figure 7** Mapview is programmtically a simple way to display insightful and interactive data. 


```{r}
renters <- ggplot(bach_housing, aes(fill = percent_renters)) + 
  geom_sf() + 
  theme_void() + 
  scale_fill_viridis_c(option = "rocket") + 
  labs(title = "Percent of Population w/ Bachelor's Degree Renting by Census tract",
...
owners <- ggplot(bach_housing, aes(fill = percent_owners)) + 
  ...
  theme_void() + 
  scale_fill_viridis_c(option = "rocket") + 
  labs(title = "Percent of Population w/ Bachelor's Degree That Own Their Home by Census tract",
       subtitle = "Washington & Multnomah County, Oregon",
       fill = "% Owners",
       caption = "2017-2021 ACS | tidycensus R package")
